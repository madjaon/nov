<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('admin.post.index') }}"><i class="fa fa-gamepad"></i> <span>Danh sách truyện</span></a></li>
            <li><a href="{{ route('admin.post.create') }}"><i class="fa fa-plus"></i> <span>Thêm truyện</span></a></li>
            <li><a href="{{ route('admin.posttype.index') }}"><i class="fa fa-list"></i> <span>Thể loại</span></a></li>
            <li><a href="{{ route('admin.postseri.index') }}"><i class="fa fa-list"></i> <span>Seri truyện</span></a></li>
            <li><a href="{{ route('admin.posttag.index') }}"><i class="fa fa-tags"></i> <span>Tác giả</span></a></li>
            ...
            <li><a href="{{ route('admin.crawler2.index') }}"><i class="fa fa-bug"></i> <span>Crawler Novel</span></a></li>
            @endif
