...
$config = array(
	...
	*/
	...
	'access_keys' => array('akey', 'db0ac2431a2e87c54852dbb0e7b9ed3d'),
	...
	*******************/
	...
	'hidden_folders'                          => array('thumb','thumb2','thumb3'),
	...
	*/
	...
	'relative_image_creation_width'           => array( 160, 80, 320 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 210, 80, 420 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
